...
import net.axd.stevenmod.item.ModArmorMaterials;
...
public class AsianArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<AsianArmorItem>(this, "controller",
                20, this::predicate));
    }
